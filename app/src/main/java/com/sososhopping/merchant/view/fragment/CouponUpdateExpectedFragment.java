...
import com.sososhopping.merchant.databinding.FragmentCouponUpdateExpectedBinding;
...
import com.sososhopping.merchant.viewmodel.CouponUpdateExpectedViewModel;

import java.util.Calendar;
import java.util.function.Consumer;

public class CouponUpdateExpectedFragment extends Fragment {
    ...
    FragmentCouponUpdateExpectedBinding binding;
    CouponUpdateExpectedViewModel viewModel;

    public CouponUpdateExpectedFragment() {

    }

    public static CouponUpdateExpectedFragment newInstance(int storeId, int couponId) {
        CouponUpdateExpectedFragment fragment = new CouponUpdateExpectedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_coupon_update_expected, container, false);

        viewModel = new ViewModelProvider(getViewModelStore(), new ViewModelProvider.NewInstanceFactory()).get(CouponUpdateExpectedViewModel.class);
        ...
        binding.shopListToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.couponUpdateExpected) viewModel.requestRegister(storeId, couponId, onSuccess);
                return true;
            }
        });
